...
class AnimationRulesTest {
    ...
    private fun rulesToTest(rulesToTest: List<String>) {
        rulesToTest.forEach { filename ->
            ...
            val animationRules = json.decodeFromString<AnimationRules?>(rulesJson)
            ...
            val redecoded = json.decodeFromJsonElement<AnimationRules>(outputRuleElement)
